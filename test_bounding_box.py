...
image_path = base_directory / 'images' / 'Ahri' / 'Academy Ahri' / 'Attack1_toRun.SKINS_Ahri_ASU_PrePro.anm_Attack1_toRun.SKINS_Ahri_ASU_PrePro.anm_Armature_frame1_camera0.jpg'
bbox_path = base_directory / 'labels' / 'Ahri' / 'Academy Ahri' / 'Attack1_toRun.SKINS_Ahri_ASU_PrePro.anm_Attack1_toRun.SKINS_Ahri_ASU_PrePro.anm_Armature_frame1_camera0.txt'
