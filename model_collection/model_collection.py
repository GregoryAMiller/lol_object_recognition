...
def main():
    ...
    champions_list = ['Ahri']  # Add champion names like 'Ahri', 'Aatrox', etc. Leave empty to download all models.
    model_limit = None # Set the maximum number of models to download (None for all models)
