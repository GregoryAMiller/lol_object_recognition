...
# change where the model/model data is saved 
version = '1.3'
...
# model = 'yolov9c'
model = 'yolov8s'
model_directory = Path.cwd().parent.parent / 'models' / 'base_yolo_models' / f'base_{model}_model'
...
test_dir = Path(f'{base_directory}/data/test/images')  # Source directory for detection
train_dir = Path(f'{base_directory}/data/train/images')  # Training images directory
val_dir = Path(f'{base_directory}/data/val/images')  # Validation images directory
...
save_file_dir = Path.cwd().parent.parent / f'models/champion_detection_model/version{version[0]}/version{version}'
